...
const routes: Routes = [
    ...
    { path: 'select', loadChildren: '../pages/select/forms.module#FormModule' },
    ...
    { path: 'alertas', loadChildren: '../modules/alertas/alertas.module#AlertasModule'},
    { path: 'catalogos', loadChildren: '../modules/catalogos/catalogos.module#CatalogosModule'},
    { path: 'viaticos', loadChildren: '../modules/viaticos/viaticos.module#ViaticosModule'}
  ]}
];
